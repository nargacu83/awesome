...
- There are two layouts: Master stack and Monocle/Max.
  ...
  Monocle/Max is used when i need to focus on the focus app.
...
- Icons are from [Feather](https://feathericons.com/) I wanted to used real icon files, not icons in nerd fonts.
...
Thanks to [dmun](https://github.com/dmun/awesome) for his configuration files i used as a base.
